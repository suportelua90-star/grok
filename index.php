...
<html lang="pt-BR">
    ...
    <head>
        <title><?php echo isset($page_title) ? $page_title : "PW REBRANDS – Plataforma Profissional IPTV"; ?></title>
        <meta charset="utf-8" />
			...
			<div class="d-flex flex-column flex-lg-row flex-column-fluid">
						...
						<div class="w-lg-500px p-10">
							<form class="form w-100" novalidate="novalidate" id="kt_sign_in_form" data-kt-redirect-url="index.html" action="#">
								...
								<div class="fv-row mb-8">
									<input type="text" placeholder="Usuário" name="username" autocomplete="off" class="form-control bg-transparent" />
								</div>
				...
				<div class="d-flex flex-lg-row-fluid w-lg-50 bgi-size-cover bgi-position-center order-1 order-lg-2" style="background-image: url(<?php echo $static_url; ?>media/images/auth-bg.png)">
					<div class="d-flex flex-column flex-center py-7 py-lg-15 px-5 px-md-15 w-100">
						...
						<h1 class="d-none d-lg-block text-white fs-2qx fw-bolder text-center mb-5">PW REBRANDS – Plataforma Profissional IPTV</h1>
